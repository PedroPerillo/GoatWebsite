  ...
  return (
    <div className="App">
      <PageLayout>
        ...
        <div className="mx-auto max-w-7xl sm:px-6 py-36 pb-44 pt-20 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 py-24 shadow-2xl sm:rounded-3xl">
            <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Fit Check
            </h2>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Get started
              </a>
              <a
