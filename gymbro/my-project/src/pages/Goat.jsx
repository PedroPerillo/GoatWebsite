    ...
    return(
        <PageLayout>
            ...
            <div className="flex flex-row justify-center">
                ...
                <div className="flex justify-center items-center basis-2/4 py-5 bg-violet-200 border-2 rounded-md m-5">
            ...
            <div className="flex flex-row justify-center">
                ...
                <div className="basis-1/2 py-5 bg-violet-200 border-2 rounded-md m-5">
                    <Link
                        to="/Contact"
