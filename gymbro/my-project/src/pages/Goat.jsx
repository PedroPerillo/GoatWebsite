  ...
  return (
    <PageLayout>
      ...
      <div className="flex flex-row justify-center">
        <div className="p-10 basis-1/4 py-5 bg-slate-300 border-2 rounded-md m-5 text-left">
        ...
        <div className="flex justify-center items-center basis-2/4 py-5 bg-slate-300 border-2 rounded-md m-5">
          <img className="p-4 size-auto ml-2" src="/2.jpg" alt="GymBro" />
        </div>
      </div>
      <div className="flex flex-row justify-center">
        <div className="p-10 basis-1/4 py-5 bg bg-slate-300 border-2 rounded-md m-5 text-left">
          <div className="text-2xl font-bold text-black font-serif">
            Instruction:
          </div>
          <ul className="">
            ...
            <br></br>
            <li>
              Bottom right: It the setting where you can change your layout.
            </li>
          </ul>
        </div>
        <div className="basis-1/2 py-5 bg-slate-300 border-2 rounded-md m-5">
          <Link
            to="/Contact"
