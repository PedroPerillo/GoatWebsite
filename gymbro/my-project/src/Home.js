    ...
    <>
      <div className="App">
                  ...
                  <div className="flex flex-col justify-between rounded-3xl bg-white p-8 shadow-xl ring-1 ring-gray-900/10 sm:p-10">
                    <div>
                      ...
                      <p className="mt-6 text-base leading-7 text-gray-600">
                        Modi dolorem expedita deleniti. Corporis iste qui
                        inventore pariatur adipisci vitae.
                      </p>
                      <ul
                        role="list"
                ...
                <header className="bg-white/40 backdrop-blur-sm  absolute z-40 shadow-lg top-0">
                  ...
                  <div className="flex flex-col justify-between rounded-3xl bg-white p-8 shadow-xl ring-1 ring-gray-900/10 sm:p-10">
                    <div>
                      ...
                      <p className="mt-6 text-base leading-7 text-gray-600">
                        Explicabo quo fugit vel facere ullam corrupti non
                        dolores. Expedita eius sit sequi.
                      </p>
                      <ul
                        role="list"
                        className="mt-10 space-y-4 text-sm leading-6 text-gray-600"
        ...
        <div className="flex flex-row border-8 border-blue-700 h-svh ">
          <div className="bg-stoneAdd-100 shadow-2xl border-1 basis-1/2  h-6/7 m-12 mr-4 rounded-3xl">
            FIT CHECK
          </div>
          <div className="bg-stone-100 shadow-2xl basis-1/2  h-6/7 m-12 ml-4 rounded-3xl">
            GOAT
          </div>
        </div>
